    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button 
              ...
              className="bg-orange-500 hover:bg-orange-600 text-white border-0 font-normal"
            >
              Get Started
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <Badge className="mb-6 bg-orange-100 text-orange-700 border-orange-200 font-normal">
            ...
            <Button 
              onClick={handleGetStarted}
              size="lg"
              className="bg-orange-500 hover:bg-orange-600 text-white text-lg px-8 py-6 rounded-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 font-normal"
            >
              Start Your Journey
      ...
      <section className="container mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Participants */}
          <Card className="border-2 border-gray-200 hover:border-orange-300 hover:shadow-xl transition-all duration-300 bg-white">
      ...
      {/* How It Works */}
      <section className="container mx-auto px-6 py-16 bg-orange-50 rounded-3xl mx-8 mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            <div className="w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-medium text-lg">
              1
            </div>
      ...
      {/* Footer */}
      <footer className="bg-white/90 backdrop-blur-md border-t border-gray-200 py-12">
