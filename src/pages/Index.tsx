...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[hsla(24,100%,83%,1)] to-[hsla(341,91%,68%,1)]">
      {/* Navigation */}
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-white border-0 font-normal shadow-lg"
            >
              Get Started
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <Badge className="mb-6 bg-white/20 text-gray-800 border-white/30 font-normal backdrop-blur-sm">
            ...
            <Button 
              onClick={handleGetStarted}
              size="lg"
              className="bg-gradient-to-r from-orange-400 to-orange-600 hover:from-orange-500 hover:to-orange-700 text-white text-lg px-8 py-6 rounded-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 font-normal"
            >
              Start Your Journey
      ...
      <section className="container mx-auto px-6 py-16 bg-white/80 backdrop-blur-sm rounded-3xl mx-8 mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center">
            <div className="w-12 h-12 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-medium text-lg">
              1
            </div>
